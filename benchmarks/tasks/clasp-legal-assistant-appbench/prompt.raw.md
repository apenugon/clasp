...
- Start with the Clasp app files and `scripts/verify.sh`.
- Use the generated benchmark-prep artifacts to understand the app-owned edit surface and guarded runtime/test surfaces.
