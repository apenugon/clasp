...
require_pattern "examples/swarm-native/GoalManagerChildLoopMonitorHarness.clasp" 'childLoopLaunchOutcome'
...
require_pattern "scripts/test-goal-manager-child-loop-monitor.sh" 'stale-live-running=true'
