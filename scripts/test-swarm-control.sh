...
grep -F --quiet 'lane_memory_mb="${CLASP_SWARM_LANE_MEMORY_MB:-10240}"' "$project_root/scripts/clasp-swarm-start.sh"
grep -F --quiet 'min_available_memory_mb="${CLASP_SWARM_MIN_AVAILABLE_MEMORY_MB:-32768}"' "$project_root/scripts/clasp-swarm-start.sh"
