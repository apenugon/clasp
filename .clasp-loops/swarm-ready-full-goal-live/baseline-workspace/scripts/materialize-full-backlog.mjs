...
const laneConfig = {
  ...
  TY: {
    ...
    likelyFiles: [
      ...
      "deprecated/bootstrap/src/Clasp/Checker.hs",
      "deprecated/bootstrap/src/Clasp/Diagnostic.hs",
      "deprecated/bootstrap/src/Clasp/Lower.hs",
      "test/Main.hs",
      "docs/clasp-spec-v0.md",
    ],
  ...
  CP: {
    ...
    likelyFiles: [
      "deprecated/bootstrap/src/Clasp/",
      "runtime/",
      "scripts/",
      "docs/",
      "agents/",
...
const specialDependencies = {
  ...
  "BM-041": ["CP-029", "CP-030", "CP-031", "CP-032", "AI-016", "AI-017"],
  "FS-017": ["FS-015"],
  "FS-025": ["TY-027", "TY-028", "FS-020", "FS-021", "FS-022"],
  "AI-016": ["CP-019", "CP-022", "CP-028", "WF-010"],
  "AI-017": ["CP-019", "CP-021", "TY-022", "AI-016"],
  "NB-010": ["NB-002"],
  "NB-011": ["NB-010"],
  "NB-003": ["NB-011"],
  "CP-030": ["CP-005", "FS-025"],
  "CP-031": ["CP-011", "CP-015"],
  "CP-032": ["CP-007", "TY-021"],
  "SC-023": ["TY-024"],
  "TY-027": ["TY-009"],
  "TY-028": ["TY-027"],
};
