...
- Implement `WF-014` as one narrow slice of work: Add typed workflow audit events for transitions, retries, operator handoffs, upgrades, and rollbacks
...
- `WF-014` is implemented without breaking previously integrated tasks
