...
- Implement `TY-012` as one narrow slice of work: Add constrained or refinement-style value types for application-level invariants
...
- `TY-012` is implemented without breaking previously integrated tasks
