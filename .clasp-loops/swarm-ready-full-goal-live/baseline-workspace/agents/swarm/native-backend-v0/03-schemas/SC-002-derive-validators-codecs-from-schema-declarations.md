...
Derive validators/codecs from schema declarations
...
- Implement `SC-002` as one narrow slice of work: Derive validators/codecs from schema declarations
...
- `SC-002` is implemented without breaking previously integrated tasks
