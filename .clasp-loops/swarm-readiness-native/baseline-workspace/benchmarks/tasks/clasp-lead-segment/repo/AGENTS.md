...
- Keep the solution minimal and preserve the existing native-served route flow.
...
3. Update `Main.clasp` only if the shared-contract change requires route or rendering changes.
