...
Add secret-aware value wrappers and redaction rules
...
- Implement `SC-012` as one narrow slice of work: Add secret-aware value wrappers and redaction rules
...
- `SC-012` is implemented without breaking previously integrated tasks
