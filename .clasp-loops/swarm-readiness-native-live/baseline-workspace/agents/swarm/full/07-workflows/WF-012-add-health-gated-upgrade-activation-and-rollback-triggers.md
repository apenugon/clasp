...
Add health-gated upgrade activation and rollback triggers
...
- Implement `WF-012` as one narrow slice of work: Add health-gated upgrade activation and rollback triggers
...
- `WF-012` is implemented without breaking previously integrated tasks
