...
Add env/config decoding from schemas
...
- Implement `SC-007` as one narrow slice of work: Add env/config decoding from schemas
...
- `SC-007` is implemented without breaking previously integrated tasks
