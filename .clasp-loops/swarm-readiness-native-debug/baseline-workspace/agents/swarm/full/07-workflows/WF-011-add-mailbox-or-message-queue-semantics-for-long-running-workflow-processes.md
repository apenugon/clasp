...
Add mailbox or message-queue semantics for long-running workflow processes
...
- Implement `WF-011` as one narrow slice of work: Add mailbox or message-queue semantics for long-running workflow processes
...
- `WF-011` is implemented without breaking previously integrated tasks
