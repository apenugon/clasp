...
- Secret consumers may delegate declared secret handles across agent, tool, and workflow handoffs, yielding audience-bound handoff metadata instead of raw secret values while preserving the original secret-access checks at resolution time.
