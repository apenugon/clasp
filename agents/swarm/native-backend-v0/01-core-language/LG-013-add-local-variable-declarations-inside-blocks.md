...
Add local variable declarations inside blocks
...
- Implement `LG-013` as one narrow slice of work: Add local variable declarations inside blocks
...
- `LG-013` is implemented without breaking previously integrated tasks
