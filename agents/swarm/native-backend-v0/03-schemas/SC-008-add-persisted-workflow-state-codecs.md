...
Add persisted workflow-state codecs
...
- Implement `SC-008` as one narrow slice of work: Add persisted workflow-state codecs
...
- `SC-008` is implemented without breaking previously integrated tasks
