...
Add wildcard and nested constructor patterns
...
- Implement `TY-004` as one narrow slice of work: Add wildcard and nested constructor patterns
...
- `TY-004` is implemented without breaking previously integrated tasks
