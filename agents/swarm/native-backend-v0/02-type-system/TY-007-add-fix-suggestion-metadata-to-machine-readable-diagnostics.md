...
Add fix-suggestion metadata to machine-readable diagnostics
...
- Implement `TY-007` as one narrow slice of work: Add fix-suggestion metadata to machine-readable diagnostics
...
- `TY-007` is implemented without breaking previously integrated tasks
