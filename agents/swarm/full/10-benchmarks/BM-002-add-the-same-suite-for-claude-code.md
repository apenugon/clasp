...
Add the same suite for `Claude Code`
...
- Implement `BM-002` as one narrow slice of work: Add the same suite for `Claude Code`
...
- `BM-002` is implemented without breaking previously integrated tasks
