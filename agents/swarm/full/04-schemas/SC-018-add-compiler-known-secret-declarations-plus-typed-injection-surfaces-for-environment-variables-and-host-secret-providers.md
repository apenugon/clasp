...
Add compiler-known secret declarations plus typed injection surfaces for environment variables and host secret providers
...
- Implement `SC-018` as one narrow slice of work: Add compiler-known secret declarations plus typed injection surfaces for environment variables and host secret providers
...
- `SC-018` is implemented without breaking previously integrated tasks
