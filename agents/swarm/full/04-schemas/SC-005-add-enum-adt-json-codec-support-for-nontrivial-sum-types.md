...
Add enum/ADT JSON codec support for nontrivial sum types
...
- Implement `SC-005` as one narrow slice of work: Add enum/ADT JSON codec support for nontrivial sum types
...
- `SC-005` is implemented without breaking previously integrated tasks
