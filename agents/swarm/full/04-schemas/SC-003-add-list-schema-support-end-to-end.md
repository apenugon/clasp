...
Add list schema support end to end
...
- Implement `SC-003` as one narrow slice of work: Add list schema support end to end
...
- `SC-003` is implemented without breaking previously integrated tasks
