...
Add transactional semantic edits with preview, atomic apply, and semantic rollback support for compiler-known change plans
...
- Implement `TY-021` as one narrow slice of work: Add transactional semantic edits with preview, atomic apply, and semantic rollback support for compiler-known change plans
...
- `TY-021` is implemented without breaking previously integrated tasks
