...
Add type parameters for records, ADTs, and functions
...
- Implement `TY-003` as one narrow slice of work: Add type parameters for records, ADTs, and functions
...
- `TY-003` is implemented without breaking previously integrated tasks
