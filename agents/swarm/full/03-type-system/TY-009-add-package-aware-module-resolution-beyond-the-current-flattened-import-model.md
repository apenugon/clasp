...
Add package-aware module resolution beyond the current flattened import model
...
- Implement `TY-009` as one narrow slice of work: Add package-aware module resolution beyond the current flattened import model
