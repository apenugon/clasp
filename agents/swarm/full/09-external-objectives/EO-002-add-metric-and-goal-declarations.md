...
Add metric and goal declarations
...
- Implement `EO-002` as one narrow slice of work: Add metric and goal declarations
...
- `EO-002` is implemented without breaking previously integrated tasks
