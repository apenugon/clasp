...
Design declarations for repo memory
...
- Implement `CP-001` as one narrow slice of work: Design declarations for repo memory
...
- `CP-001` is implemented without breaking previously integrated tasks
