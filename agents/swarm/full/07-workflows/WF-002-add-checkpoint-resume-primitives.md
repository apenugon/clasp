...
Add checkpoint/resume primitives
...
- Implement `WF-002` as one narrow slice of work: Add checkpoint/resume primitives
...
- `WF-002` is implemented without breaking previously integrated tasks
