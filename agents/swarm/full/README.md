...
- `03-type-system`: Type System And Diagnostics (22 tasks)
- `04-schemas`: Schemas And Trust Boundaries (22 tasks)
- `05-full-stack`: Full-Stack Runtime And App Layer (24 tasks)
- `06-control-plane`: Control Plane (25 tasks)
- `07-workflows`: Durable Workflows And Hot Swap (17 tasks)
- `08-ai-platform`: AI-Native Platform (15 tasks)
- `09-external-objectives`: External-Objective Adaptation (7 tasks)
- `10-benchmarks`: Benchmark Program (34 tasks)
