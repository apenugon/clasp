...
checkerTests =
  testGroup
    ...
    , testCase "typechecks the compiler self-hosting lowering and emitter example file" $ do
        ...
        case exitCode of
          ...
          ExitSuccess -> do
            ...
            assertEqual
              ...
              (Just (String "function renderLead(lead) = call String(lead)"))
            ...
            assertEqual
              ...
              (Just (String "hello"))
              (lookupObjectKey "emittedGreeting" runtimeValue)
            assertEqual
