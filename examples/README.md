...
- [support-agent/demo.mjs](/home/akul/DevProjects/synthspeak/examples/support-agent/demo.mjs): runs two typed-tool scenarios and validates runtime-selected structured outputs against the compiled schema registry
