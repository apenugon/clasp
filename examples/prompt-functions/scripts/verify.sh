...
run_verify() {
  cd "$project_root"
  cabal run claspc -- check examples/prompt-functions/Main.clasp
  cabal run claspc -- compile examples/prompt-functions/Main.clasp -o examples/prompt-functions/compiled.mjs
