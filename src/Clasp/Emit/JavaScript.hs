...
emitRuntimePrelude =
  ...
  , "  const rawOptions = options && typeof options === \"object\" ? options : {};"
  , "  if (rawOptions.migrateState !== undefined && typeof rawOptions.migrateState !== \"function\") {"
  , "    throw new Error(`Workflow ${sourceWorkflow.name} state migration hooks must be functions.`);"
  , "  }"
  , "  if (rawOptions.prepare !== undefined && typeof rawOptions.prepare !== \"function\") {"
  , "    throw new Error(`Workflow ${sourceWorkflow.name} upgrade prepare handlers must be functions.`);"
  , "  }"
  , "  if (rawOptions.activate !== undefined && typeof rawOptions.activate !== \"function\") {"
