...
run_verify() {
  cd "$project_root"
  run_native_export "$stage1_native_path" nativeProjectText "--project-entry=$project_root/src/Main.clasp" "$stage1_verify_ir_path"
  run_native_export "$stage1_native_path" nativeImageProjectText "--project-entry=$project_root/src/Main.clasp" "$stage1_verify_native_path"
  ...
  run_native_export "$stage1_native_path" checkProjectText "--project-entry=$project_root/src/Main.clasp" "$verify_root/promoted.source.check.txt"
  run_native_export "$stage1_verify_native_path" checkProjectText "--project-entry=$project_root/src/Main.clasp" "$verify_root/rebuilt.source.check.txt"
  cmp -s "$verify_root/promoted.source.check.txt" "$verify_root/rebuilt.source.check.txt"

  run_native_export "$stage1_native_path" checkCoreProjectText "--project-entry=$project_root/src/Main.clasp" "$verify_root/promoted.source.check-core.json"
  run_native_export "$stage1_verify_native_path" checkCoreProjectText "--project-entry=$project_root/src/Main.clasp" "$verify_root/rebuilt.source.check-core.json"
  cmp -s "$verify_root/promoted.source.check-core.json" "$verify_root/rebuilt.source.check-core.json"

  run_native_export "$stage1_native_path" compileProjectText "--project-entry=$project_root/src/Main.clasp" "$verify_root/promoted.source.compile.mjs"
  run_native_export "$stage1_verify_native_path" compileProjectText "--project-entry=$project_root/src/Main.clasp" "$verify_root/rebuilt.source.compile.mjs"
  cmp -s "$verify_root/promoted.source.compile.mjs" "$verify_root/rebuilt.source.compile.mjs"

  run_native_export "$stage1_native_path" nativeProjectText "--project-entry=$project_root/src/Main.clasp" "$verify_root/promoted.source.native.ir"
  run_native_export "$stage1_verify_native_path" nativeProjectText "--project-entry=$project_root/src/Main.clasp" "$verify_root/rebuilt.source.native.ir"
  cmp -s "$verify_root/promoted.source.native.ir" "$verify_root/rebuilt.source.native.ir"

  run_native_export "$stage1_native_path" nativeImageProjectText "--project-entry=$project_root/src/Main.clasp" "$verify_root/promoted.source.native.image.json"
  run_native_export "$stage1_verify_native_path" nativeImageProjectText "--project-entry=$project_root/src/Main.clasp" "$verify_root/rebuilt.source.native.image.json"
